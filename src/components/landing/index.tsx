        ...
        <S.LandingSection id='home' ref={landingRef}>
            ...
            <S.LandingRightContainer>
                <S.LandingImageContainer>
                    {loading ? <S.LandingMainImage src={ LOADER}  alt='loader'/> : error ? <S.LandingMainImage src={ERROR_AVATAR_IMAGE} alt='error_image'/> : <S.LandingMainImage src={data.profile.url} alt="ts-image" />}
                </S.LandingImageContainer>
            </S.LandingRightContainer>
        </S.LandingSection>
    )
